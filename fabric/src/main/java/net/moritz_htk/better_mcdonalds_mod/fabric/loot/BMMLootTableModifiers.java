...
public class BMMLootTableModifiers {
    ...
    private static void addLoot(ResourceKey<LootTable> lootTable, ResourceKey<LootTable> id, FabricLootTableBuilder tableBuilder, float chance, Item item, NumberProvider count) {
