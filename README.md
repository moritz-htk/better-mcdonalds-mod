...
## 🔗 Dependencies
- [Balm](https://github.com/twelveiterations/balm) (v26.2.0.x and above)
...
### ⚙️ `gradle.properties`
```
better_mcdonalds_mod_version=[VERSION FROM BELOW]
```
![Version](https://img.shields.io/modrinth/v/kdnePgr1)
