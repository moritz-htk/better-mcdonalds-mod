...
public class BMMAdvancementProvider extends AdvancementProvider {
    ...
    private static class BMMAdvancements implements AdvancementProvider.AdvancementGenerator {
        ...
        public void generate(HolderLookup.@NotNull Provider provider, @NotNull Consumer<AdvancementHolder> consumer, @NotNull ExistingFileHelper existingFileHelper) {
            ...
            AdvancementHolder CRAFT_KNIFE = createAdvancement("craft_knife", BMMItems.KNIFE.get(), AdvancementType.TASK, "knife", InventoryChangeTrigger.TriggerInstance.hasItems(BMMItems.KNIFE.get()), ROOT, consumer);
            AdvancementHolder CRAFT_BURGER = createAdvancement("craft_burger", BMMItems.HAMBURGER.get(), AdvancementType.GOAL, "hamburger", InventoryChangeTrigger.TriggerInstance.hasItems(BMMItems.HAMBURGER.get()), CRAFT_KNIFE, consumer);
