...
import net.kyronis.better_mcdonalds_mod.forge.world.biome_modifier.BMMBiomeModifiers;
...
public class BMMWorldGenProvider extends DatapackBuiltinEntriesProvider {
    ...
    public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder().add(Registries.CONFIGURED_FEATURE, BMMConfiguredFeatures::bootstrap).add(Registries.PLACED_FEATURE, BMMPlacedFeatures::bootstrap).add(ForgeRegistries.Keys.BIOME_MODIFIERS, BMMBiomeModifiers::bootstrap);
}