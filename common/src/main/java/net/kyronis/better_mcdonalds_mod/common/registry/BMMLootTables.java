...
import net.kyronis.better_mcdonalds_mod.common.loot.modifier.BMMChestLootModifier;
import net.kyronis.better_mcdonalds_mod.common.loot.modifier.BMMMobLootModifier;
...
public class BMMLootTables {
    public static void initialize(BalmLootTables lootTables) {
        ...
        lootTables.registerLootModifier(Identifier.fromNamespaceAndPath(BetterMcDonaldsMod.MOD_ID, "chest_loot"), new BMMChestLootModifier());
        lootTables.registerLootModifier(Identifier.fromNamespaceAndPath(BetterMcDonaldsMod.MOD_ID, "mob_loot"), new BMMMobLootModifier());
    }
}