...
public class BMMTags {
    public static class Items {
        ...
        // Food Tags
        public static final TagKey<Item> FOODS_CHEESES = registerCommonKey("foods/cheeses");
        public static final TagKey<Item> FOODS_SAUCES = registerCommonKey("foods/sauces");
        public static final TagKey<Item> FOODS_BURGERS = registerCommonKey("foods/burgers");
        public static final TagKey<Item> FOODS_SIDE_DISHES = registerModKey("foods/side_dishes");
        public static final TagKey<Item> FOODS_DRINKS = registerCommonKey("foods/drinks");
