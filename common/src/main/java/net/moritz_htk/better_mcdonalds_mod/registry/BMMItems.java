...
public class BMMItems {
    ...
    public static final RegistrySupplier<BMMDrinkItem> COCA_COLA = ITEMS.register("coca_cola", () -> new BMMDrinkItem(registerItemProperties().food(registerFoodValues(3, 0.4f))));
    public static final RegistrySupplier<BMMDrinkItem> FANTA = ITEMS.register("fanta", () -> new BMMDrinkItem(registerItemProperties().food(registerFoodValues(3, 0.4f))));
